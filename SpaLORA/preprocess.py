...
def construct_neighbor_graph(adata_omics1, adata_omics2, datatype):
    # construct spatial neighbor graphs
    ################# spatial graph #################
    if datatype == 'spatial ATAC–RNA-seq':
        n_neighbors = 16
    elif datatype == 'Slide-tags':
        n_neighbors = 1
    elif datatype == '10x Genomics Visium':
        n_neighbors = 18
