...
Potts/CRF clustering, alpha expansion, multiscale graph features, prototype unary, dynamic graphs and shared/private representations are established prior art. Optional modality views alone are also prior art. The empirically supported Night-16E object is a support-weighted operator over the inherited same-start, same-base Night-15F direct energy: 0.544877/0.557795 versus 0.167510/0.266756 ARI/NMI on the independent human hippocampus. This evidence is obtained in the inherited base-self-return context. The present ablations do not isolate relation-specific stay because the stay-off control disables base and relation stay together. They also do not separate edge-selective support from uniform global attenuation because uniform-mass-matched and permuted-support controls were not preregistered. Boundary-exclusion, private-conflict unaries, relation-specific stay and relation-specific edge selectivity therefore remain hypotheses.
