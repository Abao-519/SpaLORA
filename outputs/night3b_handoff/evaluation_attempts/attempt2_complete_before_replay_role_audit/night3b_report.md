...
**P0-ARCH: PASS; probes: 24/24; main experiment: 120/120; failure JSON: 0; training semantic label access: 0; method recommendation: MIXED_EVIDENCE.**

## Integrity and replay

- FULL_IGE CPU shared-forward/raw-loss/coefficient/total-loss/gradient/one-step Adam parity passed on 3/3 datasets.
- FULL_IGE final replay against Night-3AF IGE passed on 0/15 dataset-seed cells.
